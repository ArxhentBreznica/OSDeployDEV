...
begin {
    function Set-XMLFile {
        ...
        $OfficeXML = [XML]@"
<Configuration ID="84dcd094-d4ee-4db1-ac69-524c219eb38b">
  <Info Description="Default Installation" />
  <Add OfficeClientEdition="32" Channel="Broad" ForceUpgrade="TRUE" MigrateArch="TRUE">
  ...
  <RemoveMSI />
  <AppSettings>
    <Setup Name="Company" Value="BDO AG" />
